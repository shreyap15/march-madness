...
def predict_full_bracket(
    bracket_path: str = "submissions/bracket_2026.csv",
    preds_path: str = "submissions/WNCAATourneyPredictions_with_preds.csv",
    out_path: str = "submissions/bracket_2026_results.csv",
    viz_path: str = "submissions/bracket_2026_visual.md",
) -> None:
